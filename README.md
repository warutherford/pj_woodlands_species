...
If using this, do code/actions in the order listed above with data and code in folder starting PJ_Woodlands_Organize_RangeHealth_GroundCover, then actions scripted in GEE_JavaScript_code_PJ_Extraction.txt (in GEE), then data and code in the PJ-Woodlands_Modeling folder.
