...
## Folder 1_PJ_Woodlands_Organize_RangeHealth_GroundCover
...
### File 2_GEE_JavaScript_code_PJ_Extraction.txt
...
## Folder 3_PJ-Woodlands_Modeling
...
If using this, do code/actions in the numeric order in the name starting with data and code in folder starting with 1 above (in R), then 2 (GEE), then 3 (in R).
